...
class DjangoSessionMiddleware(object):
    ...
    def __init__(self):
        ...
        self.wrapped_wsgi_middleware = SessionMiddleware(fake_app, cookie_key=cookie_key)
    ...
    def process_request(self, request):
        ...
        request.session.get = lambda key, default: default  # Add by zy_sunshine to fix gae django i18n problem
