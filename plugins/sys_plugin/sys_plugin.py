...
class NotifyHandler(BaseRequestHandler):
    ...
    def GET(self):
        ...
        content=template.render('plugins/sys_plugin/setup.html', params)
        #self.render2('views/admin/setup_base.html',{'m_id':'sysplugin_notify','content':content})
        # setup_base.html is a base template so we drop the prefix, make it in root path.
        return self.render2('setup_base.html',{'m_id':'sysplugin_notify','content':content})
        #Also you can use:
...
class sys_plugin(Plugin):
    ...
    def setup(self,page=None,*arg1,**arg2):
        ...
        if page.request.method=='GET':
            ...
            page.render2('/admin/base.html',{'m_id':'sysplugin_block','content':tempstr%self.blocklist})
        else:
